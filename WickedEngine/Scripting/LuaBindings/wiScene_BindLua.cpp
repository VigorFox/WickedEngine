...
void SetGlobalScene(wi::scene::Scene *scene) { globalscene = scene; }
void SetGlobalCamera(wi::scene::CameraComponent *camera) { globalcam = camera; }
wi::scene::Scene *GetGlobalScene() { return globalscene; }
wi::scene::CameraComponent *GetGlobalCamera() { return globalcam; }
...
int LoadModel(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (custom_scene) {
      ...
      if (argc > 1) {
        ...
        if (argc > 2) {
          ...
          if (matrix != nullptr) {
            ...
            wi::lua::SError(L, "LoadModel(Scene scene, string fileName, opt "
                               "Matrix transform) argument is not a matrix!");
          }
        }
        Entity root = wi::scene::LoadModel(*custom_scene->scene, fileName,
                                           transform, true);
        wi::lua::SSetLongLong(L, root);
        return 1;
      } else {
        wi::lua::SError(L, "LoadModel(Scene scene, string fileName, opt Matrix "
                           "transform) not enough arguments!");
        return 0;
      }
    } else {
      ...
      if (argc > 1) {
        ...
        if (matrix != nullptr) {
          ...
          wi::lua::SError(L, "LoadModel(string fileName, opt Matrix transform) "
    ...
    wi::lua::SError(L, "LoadModel(string fileName, opt Matrix transform) not "
                       "enough arguments!");
  }
  return 0;
}
int Pick(lua_State *L) {
  ...
  if (argc > 0) {
        ...
        if (argc > 2) {
          ...
          if (argc > 3) {
            ...
            if (custom_scene) {
              ...
              wi::lua::SError(L, "Pick(Ray ray, opt uint filterMask, opt uint "
                                 "layerMask, opt Scene scene, opt uint lod) "
                                 "4th argument is not of type Scene!");
            }
          }
        }
      }
    ...
    wi::lua::SError(
        L, "Pick(Ray ray, opt uint filterMask, opt uint layerMask, opt Scene "
           "scene, opt uint lod) first argument must be of Ray type!");
  } else {
    wi::lua::SError(L, "Pick(Ray ray, opt uint filterMask, opt uint layerMask, "
                       "opt Scene scene, opt uint lod) not enough arguments!");
  }
...
int SceneIntersectSphere(lua_State *L) {
  ...
  if (argc > 0) {
        ...
        if (argc > 2) {
          ...
          if (argc > 3) {
            ...
            if (custom_scene) {
              ...
              wi::lua::SError(
                  L, "SceneIntersectSphere(Sphere sphere, opt uint filterMask, "
                     "opt uint layerMask, opt Scene scene, opt uint lod) 4th "
                     "argument is not of type Scene!");
            }
          }
        }
      }
      auto pick = wi::scene::SceneIntersectSphere(sphere->sphere, filterMask,
                                                  layerMask, *scene, lod);
      wi::lua::SSetLongLong(L, pick.entity);
      Luna<Vector_BindLua>::push(L, XMLoadFloat3(&pick.position));
      Luna<Vector_BindLua>::push(L, XMLoadFloat3(&pick.normal));
    ...
    wi::lua::SError(L, "SceneIntersectSphere(Sphere sphere, opt uint "
                       "filterMask, opt uint layerMask, opt Scene scene, opt "
                       "uint lod) first argument must be of Sphere type!");
  } else {
    wi::lua::SError(
        L, "SceneIntersectSphere(Sphere sphere, opt uint filterMask, opt uint "
           "layerMask, opt Scene scene, opt uint lod) not enough arguments!");
  }
...
int SceneIntersectCapsule(lua_State *L) {
  ...
  if (argc > 0) {
        ...
        if (argc > 2) {
          ...
          if (argc > 3) {
            ...
            if (custom_scene) {
              ...
              wi::lua::SError(
                  L, "SceneIntersectCapsule(Capsule capsule, opt uint "
                     "filterMask, opt uint layerMask, opt Scene scene, opt "
                     "uint lod) 4th argument is not of type Scene!");
            }
          }
        }
      }
      auto pick = wi::scene::SceneIntersectCapsule(capsule->capsule, filterMask,
                                                   layerMask, *scene, lod);
      wi::lua::SSetLongLong(L, pick.entity);
      Luna<Vector_BindLua>::push(L, XMLoadFloat3(&pick.position));
      Luna<Vector_BindLua>::push(L, XMLoadFloat3(&pick.normal));
    ...
    wi::lua::SError(L, "SceneIntersectCapsule(Capsule capsule, opt uint "
                       "filterMask, opt uint layerMask, opt Scene scene, opt "
                       "uint lod) first argument must be of Capsule type!");
  } else {
    wi::lua::SError(
        L,
        "SceneIntersectCapsule(Capsule capsule, opt uint filterMask, opt uint "
        "layerMask, opt Scene scene, opt uint lod) not enough arguments!");
  }
...
Luna<Scene_BindLua>::PropertyType Scene_BindLua::properties[] = {
    lunaproperty(Scene_BindLua, Weather), {NULL, NULL}};
...
int Scene_BindLua::Merge(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (other) {
      ...
      wi::lua::SError(
          L, "Scene::Merge(Scene other) argument is not of type Scene!");
    }
  } else {
...
int Scene_BindLua::Instantiate(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (other) {
      ...
      wi::lua::SError(L, "Scene::Instantiate(Scene prefab, opt bool attached) "
                         "first argument is not of type Scene!");
    }
  } else {
    wi::lua::SError(L, "Scene::Instantiate(Scene prefab, opt bool attached) "
...
int Scene_BindLua::Entity_FindByName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Entity_FindByName(string name, opt Entity "
                       "ancestor) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Entity_Remove(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Entity_Remove(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Entity_Remove_Async(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (async == nullptr) {
      wi::lua::SError(L, "Scene::Entity_Remove_Async(Async async, Entity "
                         "entity) first argument is not an Async!");
      return 0;
    }
    ...
    wi::lua::SError(L, "Scene::Entity_Remove_Async(Async async, Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Entity_Duplicate(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Entity_Duplicate(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Entity_IsDescendant(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    wi::lua::SError(L, "Scene::Entity_IsDescendant(Entity entity, Entity "
                       "ancestor) not enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::Intersects(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (sphere != nullptr) {
      auto result =
          scene->Intersects(sphere->sphere, filterMask, layerMask, lod);
      wi::lua::SSetInt(L, (int)result.entity);
      Luna<Vector_BindLua>::push(L, result.position);
      Luna<Vector_BindLua>::push(L, result.normal);
    ...
    if (capsule != nullptr) {
      auto result =
          scene->Intersects(capsule->capsule, filterMask, layerMask, lod);
      wi::lua::SSetInt(L, (int)result.entity);
      Luna<Vector_BindLua>::push(L, result.position);
      Luna<Vector_BindLua>::push(L, result.normal);
      wi::lua::SSetFloat(L, result.depth);
    ...
    wi::lua::SError(L,
                    "Scene::Intersects(Ray|Sphere|Capsule primitive, opt uint "
                    "filterMask = ~0u, opt uint layerMask = ~0u, opt uint lod "
                    "= 0) first argument is not an accepted primitive type!");
  } else {
    wi::lua::SError(L, "Scene::Intersects(Ray|Sphere|Capsule primitive, opt "
                       "uint filterMask = ~0u, opt uint layerMask = ~0u, opt "
                       "uint lod = 0) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::IntersectsAll(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (capsule != nullptr) {
      ...
      scene->IntersectsAll(results, capsule->capsule, filterMask, layerMask,
                           lod);
      int cnt = (int)results.size();
      lua_createtable(L, cnt, 0);
      int newTable = lua_gettop(L);
    ...
    wi::lua::SError(
        L, "Scene::IntersectsAll(Ray|Sphere|Capsule primitive, opt uint "
           "filterMask = ~0u, opt uint layerMask = ~0u, opt uint lod = 0) "
           "first argument is not an accepted primitive type!");
  } else {
    wi::lua::SError(L, "Scene::IntersectsAll(Ray|Sphere|Capsule primitive, opt "
                       "uint filterMask = ~0u, opt uint layerMask = ~0u, opt "
                       "uint lod = 0) not enough arguments!");
  }
  return 0;
...
int Scene_BindLua::IntersectsFirst(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (ray != nullptr) {
      bool result =
          scene->IntersectsFirst(ray->ray, filterMask, layerMask, lod);
    ...
    wi::lua::SError(
        L,
        "Scene::IntersectsFirst(Ray primitive, opt uint filterMask = ~0u, opt "
        "uint layerMask = ~0u, opt uint lod = 0) first argument is not a Ray!");
  } else {
    wi::lua::SError(
        L, "Scene::IntersectsFirst(Ray primitive, opt uint filterMask = ~0u, "
           "opt uint layerMask = ~0u, opt uint lod = 0) not enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::Component_CreateName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateName(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateLayer(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateLayer(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateTransform(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateTransform(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateCamera(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateCamera(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateLight(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateLight(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateEmitter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateEmitter(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateHairParticleSystem(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateHairParticle(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateObject(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateObject(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateMaterial(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateMaterial(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateInverseKinematics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    InverseKinematicsComponent &component =
        scene->inverse_kinematics.Create(entity);
    Luna<InverseKinematicsComponent_BindLua>::push(L, &component);
    return 1;
  } else {
    wi::lua::SError(L, "Scene::Component_CreateInverseKinematics(Entity "
                       "entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateSpring(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateSpring(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateScript(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateScript(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateRigidBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateRigidBodyPhysics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateSoftBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateSoftBodyPhysics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateForceField(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateForceField(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateWeather(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateWeather(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateSound(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateSound(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateVideo(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateVideo(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateCollider(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateCollider(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateExpression(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateExpression(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateHumanoid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateHumanoid(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateDecal(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateDecal(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateSprite(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateSprite(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateFont(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_CreateFont(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateVoxelGrid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateVoxelGrid(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateMetadata(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_CreateMetadata(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_CreateCharacter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_CreateCharacter(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::Component_GetName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetName(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetLayer(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetLayer(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetTransform(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetTransform(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetCamera(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetCamera(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetAnimation(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetAnimation(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetMaterial(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetMaterial(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetMesh(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetMesh(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetEmitter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetEmitter(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetHairParticleSystem(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_GetHairParticle(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetLight(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetLight(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetObject(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetObject(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetInverseKinematics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    InverseKinematicsComponent *component =
        scene->inverse_kinematics.GetComponent(entity);
    if (component == nullptr) {
      return 0;
    }
    ...
    wi::lua::SError(L, "Scene::Component_GetInverseKinematics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetSpring(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetSpring(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetScript(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetScript(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetRigidBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    RigidBodyPhysicsComponent *component =
        scene->rigidbodies.GetComponent(entity);
    if (component == nullptr) {
      return 0;
    }
    ...
    wi::lua::SError(L, "Scene::Component_GetRigidBodyPhysics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetSoftBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    SoftBodyPhysicsComponent *component =
        scene->softbodies.GetComponent(entity);
    if (component == nullptr) {
      return 0;
    }
    ...
    wi::lua::SError(L, "Scene::Component_GetSoftBodyPhysics(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetForceField(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetForceField(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetWeather(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetWeather(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetSound(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetSound(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetVideo(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetVideo(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetCollider(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetCollider(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetExpression(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetExpression(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetHumanoid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetHumanoid(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetDecal(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetDecal(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetSprite(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetSprite(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetFont(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetFont(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetVoxelGrid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetVoxelGrid(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetMetadata(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_GetMetadata(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_GetCharacter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_GetCharacter(Entity entity) not enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::Component_GetInverseKinematicsArray(lua_State *L) {
  ...
  for (size_t i = 0; i < scene->inverse_kinematics.GetCount(); ++i) {
    Luna<InverseKinematicsComponent_BindLua>::push(
        L, &scene->inverse_kinematics[i]);
    lua_rawseti(L, newTable, lua_Integer(i + 1));
  }
  return 1;
}
...
int Scene_BindLua::Component_RemoveName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveName(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveLayer(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveLayer(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveTransform(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveTransform(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveCamera(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveCamera(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveAnimation(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveAnimation(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveAnimationData(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveAnimationData(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveMaterial(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveMaterial(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveMesh(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveMesh(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveEmitter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveEmitter(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveHairParticleSystem(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveHairParticleSystem(Entity "
                       "entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveLight(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveLight(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveObject(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveObject(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveInverseKinematics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveInverseKinematics(Entity "
                       "entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveSpring(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveSpring(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveScript(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveScript(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveRigidBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveRigidBodyPhysics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveSoftBodyPhysics(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveSoftBodyPhysics(Entity entity) "
                       "not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveForceField(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveForceField(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveWeather(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveWeather(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveSound(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveSound(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveVideo(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveVideo(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveCollider(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveCollider(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveExpression(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveExpression(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveHumanoid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveHumanoid(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveDecal(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveDecal(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveSprite(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveSprite(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveFont(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_RemoveFont(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveVoxelGrid(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveVoxelGrid(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveMetadata(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_RemoveMetadata(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_RemoveCharacter(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L, "Scene::Component_RemoveCharacter(Entity entity) not "
                       "enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::Component_Attach(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    wi::lua::SError(
        L, "Scene::Component_Attach(Entity entity,parent, opt bool "
           "child_already_in_local_space = false) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_Detach(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "Scene::Component_Detach(Entity entity) not enough arguments!");
  }
  return 0;
}
int Scene_BindLua::Component_DetachChildren(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "Scene::Component_DetachChildren(Entity parent) not enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::SetWeather(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc > 0) {
    WeatherComponent_BindLua *component =
        Luna<WeatherComponent_BindLua>::lightcheck(L, 1);
    if (component != nullptr) {
      scene->weather = *(component->component);
    } else {
      wi::lua::SError(
          L,
          "SetWeather(WeatherComponent weather) argument is not a component!");
    }
  } else {
    wi::lua::SError(
        L, "SetWeather(WeatherComponent weather) not enough arguments!");
  }
  return 0;
}
  ...
  if (argc > 2) {
    ...
    if (argc > 3) {
      ...
      if (_scene != nullptr) {
        ...
        wi::lua::SError(
            L, "RetargetAnimation(Entity dst, Entity src, bool bake_data, "
               "Scene src_scene = nil) 4th argument is not a scene!");
      }
    }
    ...
    wi::lua::SError(L,
                    "RetargetAnimation(Entity dst, Entity src, bool bake_data, "
                    "Scene src_scene = nil) not enough arguments!");
  }
  return 0;
}
...
int Scene_BindLua::GetOceanPosAt(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (v == nullptr) {
      wi::lua::SError(
          L, "GetOceanPosAt(Vector worldPos) first argument is not a Vector!");
      return 0;
    }
...
int Scene_BindLua::VoxelizeObject(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(
        L, "VoxelizeObject(int objectIndex, VoxelGrid voxelgrid, opt bool "
           "subtract = false, opt int lod = 0) not enough arguments!");
    return 0;
  }
  size_t objectIndex = (size_t)wi::lua::SGetInt(L, 1);
  VoxelGrid_BindLua *voxelgrid = Luna<VoxelGrid_BindLua>::lightcheck(L, 2);
  if (voxelgrid == nullptr) {
    wi::lua::SError(L, "VoxelizeObject(int objectIndex, VoxelGrid voxelgrid, "
                       "opt bool subtract = false, opt int lod = 0) second "
                       "argument is not a VoxelGrid!");
    return 0;
  }
  bool subtract = false;
  uint32_t lod = 0;
...
int Scene_BindLua::VoxelizeScene(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc < 1) {
    wi::lua::SError(L, "VoxelizeScene(VoxelGrid voxelgrid, opt bool subtract = "
                       "false, opt uint filterMask = ~0u, opt uint layerMask = "
                       "~0u, opt uint lod = 0) not enough arguments!");
    return 0;
  }
  ...
  if (voxelgrid == nullptr) {
    wi::lua::SError(
        L, "VoxelizeScene(VoxelGrid voxelgrid, opt bool subtract = false, opt "
           "uint filterMask = ~0u, opt uint layerMask = ~0u, opt uint lod = 0) "
           "first argument is not a VoxelGrid!");
    return 0;
  }
  bool subtract = false;
  uint32_t filterMask = wi::enums::FILTER_ALL;
  ...
  scene->VoxelizeScene(*voxelgrid->voxelgrid, subtract, filterMask, layerMask,
                       lod);
  return 0;
}
...
Luna<RayIntersectionResult_BindLua>::FunctionType
    RayIntersectionResult_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<RayIntersectionResult_BindLua>::PropertyType
    RayIntersectionResult_BindLua::properties[] = {{NULL, NULL}};
...
Luna<SphereIntersectionResult_BindLua>::FunctionType
    SphereIntersectionResult_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<SphereIntersectionResult_BindLua>::PropertyType
    SphereIntersectionResult_BindLua::properties[] = {{NULL, NULL}};
...
Luna<NameComponent_BindLua>::PropertyType NameComponent_BindLua::properties[] =
    {lunaproperty(NameComponent_BindLua, Name), {NULL, NULL}};
...
Luna<LayerComponent_BindLua>::FunctionType LayerComponent_BindLua::methods[] = {
    ...
    {NULL, NULL}};
Luna<LayerComponent_BindLua>::PropertyType
    LayerComponent_BindLua::properties[] = {
        lunaproperty(LayerComponent_BindLua, LayerMask), {NULL, NULL}};
...
Luna<TransformComponent_BindLua>::FunctionType
    TransformComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<TransformComponent_BindLua>::PropertyType
    TransformComponent_BindLua::properties[] = {
...
int TransformComponent_BindLua::Rotate(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (v != nullptr) {
      ...
      wi::lua::SError(
          L, "Rotate(Vector vectorRollPitchYaw) argument is not a vector!");
    }
  } else {
    wi::lua::SError(L,
                    "Rotate(Vector vectorRollPitchYaw) not enough arguments!");
  }
  return 0;
}
int TransformComponent_BindLua::RotateQuaternion(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (v != nullptr) {
      ...
      wi::lua::SError(
          L, "RotateQuaternion(Vector quaternion) argument is not a vector!");
    }
  } else {
    wi::lua::SError(
        L, "RotateQuaternion(Vector quaternion) not enough arguments!");
  }
  return 0;
}
...
int TransformComponent_BindLua::Lerp(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc > 2) {
    TransformComponent_BindLua *a =
        Luna<TransformComponent_BindLua>::lightcheck(L, 1);
    if (a != nullptr) {
      TransformComponent_BindLua *b =
          Luna<TransformComponent_BindLua>::lightcheck(L, 2);
      ...
      if (b != nullptr) {
        ...
        wi::lua::SError(L, "Lerp(TransformComponent a,b, float t) argument (b) "
                           "is not a Transform!");
      }
    } else {
      wi::lua::SError(L, "Lerp(TransformComponent a,b, float t) argument (a) "
                         "is not a Transform!");
    }
  } else {
    wi::lua::SError(
        L, "Lerp(TransformComponent a,b, float t) not enough arguments!");
  }
  return 0;
}
int TransformComponent_BindLua::CatmullRom(lua_State *L) {
  ...
  if (argc > 4) {
    ...
    if (a != nullptr) {
      ...
      if (b != nullptr) {
        TransformComponent_BindLua *c =
            Luna<TransformComponent_BindLua>::lightcheck(L, 3);

        if (c != nullptr) {
          TransformComponent_BindLua *d =
              Luna<TransformComponent_BindLua>::lightcheck(L, 4);

          if (d != nullptr) {
            float t = wi::lua::SGetFloat(L, 5);

            component->CatmullRom(*a->component, *b->component, *c->component,
                                  *d->component, t);
          } else {
            wi::lua::SError(L, "CatmullRom(TransformComponent a,b,c,d, float "
                               "t) argument (d) is not a Transform!");
          }
        } else {
          wi::lua::SError(L, "CatmullRom(TransformComponent a,b,c,d, float t) "
                             "argument (c) is not a Transform!");
        }
      } else {
        wi::lua::SError(L, "CatmullRom(TransformComponent a,b,c,d, float t) "
                           "argument (b) is not a Transform!");
      }
    } else {
      wi::lua::SError(L, "CatmullRom(TransformComponent a,b,c,d, float t) "
                         "argument (a) is not a Transform!");
    }
  } else {
    wi::lua::SError(L, "CatmullRom(TransformComponent a,b,c,d, float t) not "
                       "enough arguments!");
  }
  return 0;
}
int TransformComponent_BindLua::MatrixTransform(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (m != nullptr) {
      ...
      wi::lua::SError(
          L, "MatrixTransform(Matrix matrix) argument is not a matrix!");
    }
  } else {
...
int TransformComponent_BindLua::SetRotation(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (vec != nullptr) {
      ...
      wi::lua::SError(
          L, "SetRotation(Vector quaternion) argument is not a vector!");
    }
  } else {
...
Luna<CameraComponent_BindLua>::FunctionType CameraComponent_BindLua::methods[] =
    {lunamethod(CameraComponent_BindLua, UpdateCamera),
     ...
     {NULL, NULL}};
Luna<CameraComponent_BindLua>::PropertyType
    CameraComponent_BindLua::properties[] = {
...
int CameraComponent_BindLua::TransformCamera(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc > 0) {
    TransformComponent_BindLua *transform =
        Luna<TransformComponent_BindLua>::lightcheck(L, 1);
    ...
    wi::lua::SError(L, "TransformCamera(TransformComponent | Matrix transform) "
                       "invalid argument!");
  } else {
    wi::lua::SError(L, "TransformCamera(TransformComponent | Matrix transform) "
                       "not enough arguments!");
...
int CameraComponent_BindLua::SetOrthoVerticalSize(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetOrthoVerticalSize(float value) not enough arguments!");
  }
  return 0;
}
...
int CameraComponent_BindLua::ProjectToScreen(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(
        L,
        "ProjectToScreen(Vector point, Canvas canvas) not enough arguments!");
    return 0;
  }
  Vector_BindLua *vector = Luna<Vector_BindLua>::lightcheck(L, 1);
  if (vector == nullptr) {
    wi::lua::SError(L, "ProjectToScreen(Vector point, Canvas canvas) first "
                       "argument is not a Vector!");
    return 0;
  }
  Canvas_BindLua *canvas = Luna<Canvas_BindLua>::lightcheck(L, 2);
  if (canvas == nullptr) {
    wi::lua::SError(L, "ProjectToScreen(Vector point, Canvas canvas) second "
                       "argument is not a Canvas!");
    return 0;
  }
  XMVECTOR result = XMLoadFloat4(&vector->data);
  XMMATRIX VP = component->GetViewProjection();
  result = XMVector3TransformCoord(result, VP);
  result = XMVectorMultiplyAdd(result, XMVectorSet(0.5f, -0.5f, 1, 1),
                               XMVectorSet(0.5f, 0.5f, 0, 0));
  result = XMVectorMultiply(
      result, XMVectorSet(canvas->canvas.GetLogicalWidth(),
                          canvas->canvas.GetLogicalHeight(), 1, 1));
  Luna<Vector_BindLua>::push(L, result);
  return 1;
}

Luna<AnimationComponent_BindLua>::FunctionType
    AnimationComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<AnimationComponent_BindLua>::PropertyType
    AnimationComponent_BindLua::properties[] = {
...
Luna<MaterialComponent_BindLua>::FunctionType
    MaterialComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<MaterialComponent_BindLua>::PropertyType
    MaterialComponent_BindLua::properties[] = {
...
int MaterialComponent_BindLua::SetBaseColor(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (_color) {
      ...
      wi::lua::SError(
          L,
          "SetBaseColor(Vector color) first argument must be of Vector type!");
    }
  } else {
...
int MaterialComponent_BindLua::SetEmissiveColor(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (_color) {
      ...
      wi::lua::SError(L, "SetEmissiveColor(Vector color) first argument must "
                         "be of Vector type!");
    }
  } else {
...
int MaterialComponent_BindLua::SetTexture(lua_State *L) {
  ...
  if (argc >= 2) {
    ...
    if (textureindex >= MaterialComponent::TEXTURESLOT_COUNT) {
      wi::lua::SError(L, "SetTexture(TextureSlot slot, string resourcename) "
    ...
    wi::lua::SError(
        L,
        "SetTexture(TextureSlot slot, Texture texture) not enough arguments!");
    wi::lua::SError(L, "SetTexture(TextureSlot slot, string resourcename) not "
                       "enough arguments!");
  }
...
int MaterialComponent_BindLua::GetTexture(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (textureindex < MaterialComponent::TEXTURESLOT_COUNT) {
      ...
      wi::lua::SError(L,
                      "GetTexture(TextureSlot slot) slot index out of range!");
    }
  } else {
...
int MaterialComponent_BindLua::GetTextureName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (textureindex < MaterialComponent::TEXTURESLOT_COUNT) {
      ...
      wi::lua::SError(
          L, "GetTextureName(TextureSlot slot) slot index out of range!");
    }
  } else {
    wi::lua::SError(L,
                    "GetTextureName(TextureSlot slot) not enough arguments!");
  }
  return 0;
}
int MaterialComponent_BindLua::SetTextureUVSet(lua_State *L) {
  ...
  if (argc >= 2) {
    ...
    if (textureindex < MaterialComponent::TEXTURESLOT_COUNT) {
      ...
      wi::lua::SError(L, "SetTextureUVSet(TextureSlot slot, int uvset) slot "
                         "index out of range!");
    }
  } else {
    wi::lua::SError(
        L,
        "SetTextureUVSet(TextureSlot slot, int uvset) not enough arguments!");
  }
...
int MaterialComponent_BindLua::GetTextureUVSet(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (textureindex < MaterialComponent::TEXTURESLOT_COUNT) {
      ...
      wi::lua::SError(
          L, "GetTextureUVSet(TextureSlot slot) slot index out of range!");
    }
  } else {
    wi::lua::SError(L,
                    "GetTextureUVSet(TextureSlot slot) not enough arguments!");
  }
  return 0;
}
...
int MaterialComponent_BindLua::SetCoplanarBlending(lua_State *L) {
  ...
  if (argc < 1) {
    wi::lua::SError(L,
                    "SetCoplanarBlending(bool value): not enough arguments!");
    return 0;
  }
...
int MeshComponent_BindLua::SetMeshSubsetMaterialID(lua_State *L) {
  ...
  if (argc >= 2) {
    ...
    wi::lua::SError(L, "SetMeshSubsetMaterialID(int subsetindex, Entity "
                       "materialID) not enough arguments!");
  }
...
int MeshComponent_BindLua::GetMeshSubsetMaterialID(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "GetMeshSubsetMaterialID(int subsetindex) not enough arguments!");
  }
  return 0;
}
...
Luna<EmitterComponent_BindLua>::FunctionType
    EmitterComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<EmitterComponent_BindLua>::PropertyType
    EmitterComponent_BindLua::properties[] = {
      ...
      if (mat != nullptr) {
        ...
        if (argc > 2) {
          ...
          if (vec != nullptr) {
            ...
            wi::lua::SError(
                L, "Burst(int value, Matrix transform, opt Vector color = "
                   "Vector(1,1,1,1) third argument is not a Vector!");
          }
        }
        ...
        if (pos != nullptr) {
          ...
          if (argc > 2) {
            ...
            if (vec != nullptr) {
              ...
              wi::lua::SError(
                  L, "Burst(int value, Vector position, opt Vector color = "
                     "Vector(1,1,1,1) third argument is not a Vector!");
            }
          }
          ...
          wi::lua::SError(L,
                          "Burst(int value, Vector position, opt Vector color "
                          "= Vector(1,1,1,1) second argument is not a Matrix!");
          wi::lua::SError(L,
                          "Burst(int value, Matrix transform, opt Vector color "
                          "= Vector(1,1,1,1) second argument is not a Matrix!");
          return 0;
        }
      }
...
int EmitterComponent_BindLua::SetMotionBlurAmount(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetMotionBlurAmount(float value) not enough arguments!");
  }
...
int EmitterComponent_BindLua::SetCollidersDisabled(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetCollidersDisabled(bool value) not enough arguments!");
  }

  return 0;
}

Luna<HairParticleSystem_BindLua>::FunctionType
    HairParticleSystem_BindLua::methods[] = {{NULL, NULL}};
Luna<HairParticleSystem_BindLua>::PropertyType
    HairParticleSystem_BindLua::properties[] = {
...
Luna<LightComponent_BindLua>::FunctionType LightComponent_BindLua::methods[] = {
    ...
    {NULL, NULL}};
Luna<LightComponent_BindLua>::PropertyType
    LightComponent_BindLua::properties[] = {
...
int LightComponent_BindLua::SetColor(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (value) {
      ...
      wi::lua::SError(L,
                      "SetColor(Vector value) argument must be Vector type!");
    }
  } else {
...
int LightComponent_BindLua::SetVolumetricsEnabled(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetVolumetricsEnabled(bool value) not enough arguments!");
  }
...
Luna<ObjectComponent_BindLua>::FunctionType ObjectComponent_BindLua::methods[] =
    {lunamethod(ObjectComponent_BindLua, GetMeshID),
     ...
     {NULL, NULL}};
Luna<ObjectComponent_BindLua>::PropertyType
    ObjectComponent_BindLua::properties[] = {
...
int ObjectComponent_BindLua::SetRimHighlightColor(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (value) {
      ...
      wi::lua::SError(
          L,
          "SetRimHighlightColor(Vector value) argument must be Vector type!");
    }
  } else {
    wi::lua::SError(L,
                    "SetRimHighlightColor(Vector value) not enough arguments!");
  }
...
int ObjectComponent_BindLua::SetRimHighlightIntensity(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetRimHighlightIntensity(float value) not enough arguments!");
  }
...
int ObjectComponent_BindLua::SetRimHighlightFalloff(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetRimHighlightFalloff(float value) not enough arguments!");
  }
...
int ObjectComponent_BindLua::SetEmissiveColor(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (value) {
      ...
      wi::lua::SError(
          L, "SetEmissiveColor(Vector value) argument must be Vector type!");
    }
  } else {
...
int ObjectComponent_BindLua::SetLodDistanceMultiplier(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetLodDistanceMultiplier(float value) not enough arguments!");
  }
...
int ObjectComponent_BindLua::SetNotVisibleInMainCamera(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetNotVisibleInMainCamera(bool value) not enough arguments!");
  }
...
int ObjectComponent_BindLua::SetNotVisibleInReflections(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetNotVisibleInReflections(bool value) not enough arguments!");
  }
...
Luna<InverseKinematicsComponent_BindLua>::FunctionType
    InverseKinematicsComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<InverseKinematicsComponent_BindLua>::PropertyType
    InverseKinematicsComponent_BindLua::properties[] = {
...
Luna<SpringComponent_BindLua>::FunctionType SpringComponent_BindLua::methods[] =
    {lunamethod(SpringComponent_BindLua, SetStiffness),
     ...
     {NULL, NULL}};
Luna<SpringComponent_BindLua>::PropertyType
    SpringComponent_BindLua::properties[] = {
...
Luna<ScriptComponent_BindLua>::FunctionType ScriptComponent_BindLua::methods[] =
    {lunamethod(ScriptComponent_BindLua, CreateFromFile),
     ...
     {NULL, NULL}};
Luna<ScriptComponent_BindLua>::PropertyType
    ScriptComponent_BindLua::properties[] = {{NULL, NULL}};
...
Luna<RigidBodyPhysicsComponent_BindLua>::FunctionType
    RigidBodyPhysicsComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<RigidBodyPhysicsComponent_BindLua>::PropertyType
    RigidBodyPhysicsComponent_BindLua::properties[] = {
...
int RigidBodyPhysicsComponent_BindLua::SetDisableDeactivation(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetDisableDeactivation(bool value) not enough arguments!");
  }
  return 0;
}
...
Luna<SoftBodyPhysicsComponent_BindLua>::FunctionType
    SoftBodyPhysicsComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<SoftBodyPhysicsComponent_BindLua>::PropertyType
    SoftBodyPhysicsComponent_BindLua::properties[] = {
...
Luna<ForceFieldComponent_BindLua>::FunctionType
    ForceFieldComponent_BindLua::methods[] = {{NULL, NULL}};
Luna<ForceFieldComponent_BindLua>::PropertyType
    ForceFieldComponent_BindLua::properties[] = {
...
Luna<Weather_OceanParams_BindLua>::FunctionType
    Weather_OceanParams_BindLua::methods[] = {{NULL, NULL}};
Luna<Weather_OceanParams_BindLua>::PropertyType
    Weather_OceanParams_BindLua::properties[] = {
...
int Weather_OceanParams_Property::Set(lua_State *L) {
  Weather_OceanParams_BindLua *get =
      Luna<Weather_OceanParams_BindLua>::lightcheck(L, 1);
  if (get) {
    *data = *get->parameter;
  }
  return 0;
...
Luna<Weather_AtmosphereParams_BindLua>::FunctionType
    Weather_AtmosphereParams_BindLua::methods[] = {{NULL, NULL}};
Luna<Weather_AtmosphereParams_BindLua>::PropertyType
    Weather_AtmosphereParams_BindLua::properties[] = {
        ...
        lunaproperty(Weather_AtmosphereParams_BindLua,
...
int Weather_AtmosphereParams_Property::Set(lua_State *L) {
  Weather_AtmosphereParams_BindLua *get =
      Luna<Weather_AtmosphereParams_BindLua>::lightcheck(L, 1);
  if (get) {
    *data = *get->parameter;
  }
  return 0;
...
Luna<Weather_VolumetricCloudParams_BindLua>::FunctionType
    Weather_VolumetricCloudParams_BindLua::methods[] = {{NULL, NULL}};
Luna<Weather_VolumetricCloudParams_BindLua>::PropertyType
    Weather_VolumetricCloudParams_BindLua::properties[] = {
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     cloudAmbientGroundMultiplier),
        ...
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationSmallFirst),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationMediumFirst),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationLargeFirst),
        ...
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     gradientSmallSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     gradientMediumSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     gradientLargeSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationSmallSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationMediumSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     anvilDeformationLargeSecond),
        ...
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     coverageWindSpeedSecond),
        lunaproperty(Weather_VolumetricCloudParams_BindLua,
                     coverageWindAngleSecond),
        {NULL, NULL}};
...
int Weather_VolumetricCloudParams_Property::Set(lua_State *L) {
  Weather_VolumetricCloudParams_BindLua *get =
      Luna<Weather_VolumetricCloudParams_BindLua>::lightcheck(L, 1);
  if (get) {
    *data = *get->parameter;
  }
  return 0;
...
Luna<WeatherComponent_BindLua>::FunctionType
    WeatherComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<WeatherComponent_BindLua>::PropertyType
    WeatherComponent_BindLua::properties[] = {
        ...
        lunaproperty(WeatherComponent_BindLua,
                     volumetricCloudsWeatherMapFirstName),
        lunaproperty(WeatherComponent_BindLua,
                     volumetricCloudsWeatherMapSecondName),
        {NULL, NULL}};
...
int WeatherComponent_BindLua::SetVolumetricCloudsCastShadow(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetVolumetricCloudsCastShadow(bool value) not enough arguments!");
  }
  return 0;
}
...
int WeatherComponent_BindLua::SetRealisticSkyAerialPerspective(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "SetRealisticSkyAerialPerspective(bool value) not enough arguments!");
  }
  return 0;
}
...
int WeatherComponent_BindLua::SetRealisticSkyHighQuality(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetRealisticSkyHighQuality(bool value) not enough arguments!");
  }
  return 0;
}
...
int WeatherComponent_BindLua::SetRealisticSkyReceiveShadow(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetRealisticSkyReceiveShadow(bool value) not enough arguments!");
  }
  return 0;
}
...
int WeatherComponent_BindLua::SetVolumetricCloudsReceiveShadow(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L,
        "SetVolumetricCloudsReceiveShadow(bool value) not enough arguments!");
  }
  return 0;
}
...
int WeatherComponent_BindLua::SetColorGradingMapName(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetColorGradingMapName(string name) not enough arguments!");
  }
  return 0;
}
...
Luna<SoundComponent_BindLua>::FunctionType SoundComponent_BindLua::methods[] = {
    ...
    {NULL, NULL}};
Luna<SoundComponent_BindLua>::PropertyType
    SoundComponent_BindLua::properties[] = {
...
int SoundComponent_BindLua::SetSoundInstance(lua_State *L) {
  ...
  if (argc < 1) {
    wi::lua::SError(
        L, "SetSoundInstance(SoundInstance inst): not enough arguments!");
    return 0;
  }

  SoundInstance_BindLua *inst = Luna<SoundInstance_BindLua>::lightcheck(L, 1);
  if (inst == nullptr) {
    wi::lua::SError(L, "SetSoundInstance(SoundInstance inst): argument is not "
                       "a SoundInstance!");
    return 0;
  }
...
Luna<VideoComponent_BindLua>::FunctionType VideoComponent_BindLua::methods[] = {
    ...
    {NULL, NULL}};
Luna<VideoComponent_BindLua>::PropertyType
    VideoComponent_BindLua::properties[] = {
        lunaproperty(VideoComponent_BindLua, Filename), {NULL, NULL}};
...
int VideoComponent_BindLua::SetVideoInstance(lua_State *L) {
  ...
  if (argc < 1) {
    wi::lua::SError(
        L, "SetVideoInstance(VideoInstance inst): not enough arguments!");
    return 0;
  }

  VideoInstance_BindLua *inst = Luna<VideoInstance_BindLua>::lightcheck(L, 1);
  if (inst == nullptr) {
    wi::lua::SError(L, "SetVideoInstance(VideoInstance inst): argument is not "
                       "a VideoInstance!");
    return 0;
  }
...
Luna<ColliderComponent_BindLua>::FunctionType
    ColliderComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<ColliderComponent_BindLua>::PropertyType
    ColliderComponent_BindLua::properties[] = {
...
Luna<ExpressionComponent_BindLua>::FunctionType
    ExpressionComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<ExpressionComponent_BindLua>::PropertyType
    ExpressionComponent_BindLua::properties[] = {{NULL, NULL}};
...
int ExpressionComponent_BindLua::SetWeight(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L,
                      "SetWeight(int id, float weight) id is out of bounds!");
    }
  } else {
...
int ExpressionComponent_BindLua::SetPresetWeight(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc > 1) {
    ExpressionComponent::Preset preset =
        (ExpressionComponent::Preset)wi::lua::SGetInt(L, 1);
    float weight = wi::lua::SGetFloat(L, 2);
    int id = component->presets[size_t(preset)];
    if (id >= 0 && component->expressions.size() > id) {
      component->expressions[id].SetWeight(weight);
    } else {
      wi::lua::SError(L, "SetPresetWeight(ExpressionPreset preset, float "
                         "weight) preset doesn't exist!");
    }
  } else {
    wi::lua::SError(L, "SetPresetWeight(ExpressionPreset preset, float weight) "
                       "not enough arguments!");
  }
  return 0;
}
...
int ExpressionComponent_BindLua::GetPresetWeight(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(
          L, "GetPresetWeight(ExpressionPreset preset) preset doesn't exist!");
    }
  } else {
    wi::lua::SError(
        L, "GetPresetWeight(ExpressionPreset preset) not enough arguments!");
  }
  return 0;
}
int ExpressionComponent_BindLua::SetForceTalkingEnabled(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetForceTalkingEnabled(bool value) not enough arguments!");
  }
  return 0;
}
...
int ExpressionComponent_BindLua::SetPresetOverrideMouth(lua_State *L) {
  ...
  if (argc > 1) {
    ExpressionComponent::Preset preset =
        (ExpressionComponent::Preset)wi::lua::SGetInt(L, 1);
    ExpressionComponent::Override value =
        (ExpressionComponent::Override)wi::lua::SGetInt(L, 2);
    int id = component->presets[size_t(preset)];
    if (id >= 0 && component->expressions.size() > id) {
      component->expressions[id].override_mouth = value;
    } else {
      wi::lua::SError(L, "SetPresetOverrideMouth(ExpressionPreset preset, "
                         "ExpressionOverride override) preset doesn't exist!");
    }
  } else {
    wi::lua::SError(L, "SetPresetOverrideMouth(ExpressionPreset preset, "
                       "ExpressionOverride override) not enough arguments!");
  }
  return 0;
}
int ExpressionComponent_BindLua::SetPresetOverrideBlink(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L, "SetPresetOverrideBlink(ExpressionPreset preset, "
                         "ExpressionOverride override) preset doesn't exist!");
    }
  } else {
    wi::lua::SError(L, "SetPresetOverrideBlink(ExpressionPreset preset, "
...
int ExpressionComponent_BindLua::SetPresetOverrideLook(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L, "SetPresetOverrideLook(ExpressionPreset preset, "
                         "ExpressionOverride override) preset doesn't exist!");
    }
  } else {
    wi::lua::SError(L, "SetPresetOverrideLook(ExpressionPreset preset, "
...
int ExpressionComponent_BindLua::SetOverrideMouth(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L, "SetOverrideMouth(int id, ExpressionOverride "
                         "override) id is out of bounds!");
    }
  } else {
    wi::lua::SError(L, "SetOverrideMouth(int id, ExpressionOverride override) "
                       "not enough arguments!");
  }
  return 0;
}
int ExpressionComponent_BindLua::SetOverrideBlink(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L, "SetOverrideBlink(int id, ExpressionOverride "
                         "override) id is out of bounds!");
    }
  } else {
    wi::lua::SError(L, "SetOverrideBlink(int id, ExpressionOverride override) "
                       "not enough arguments!");
  }
  return 0;
}
int ExpressionComponent_BindLua::SetOverrideLook(lua_State *L) {
  ...
  if (argc > 1) {
    ...
    if (id >= 0 && component->expressions.size() > id) {
      ...
      wi::lua::SError(L, "SetOverrideLook(int id, ExpressionOverride override) "
                         "id is out of bounds!");
    }
  } else {
    wi::lua::SError(L, "SetOverrideLook(int id, ExpressionOverride override) "
...
Luna<HumanoidComponent_BindLua>::FunctionType
    HumanoidComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<HumanoidComponent_BindLua>::PropertyType
    HumanoidComponent_BindLua::properties[] = {{NULL, NULL}};
...
int HumanoidComponent_BindLua::GetBoneEntity(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    if (humanoidBone >= 0 && humanoidBone < arraysize(component->bones)) {
      ...
      wi::lua::SError(
          L, "GetBoneEntity(HumanoidBone bone) invalid humanoid bone!");
    }
    return 1;
  } else {
    wi::lua::SError(L,
                    "GetBoneEntity(HumanoidBone bone) not enough arguments!");
  }
  return 0;
}
...
int HumanoidComponent_BindLua::SetRagdollPhysicsEnabled(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetRagdollPhysicsEnabled(bool value) not enough arguments!");
  }
  return 0;
}
...
int HumanoidComponent_BindLua::SetIntersectionDisabled(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(
        L, "SetIntersectionDisabled(bool value) not enough arguments!");
  }
  return 0;
}
...
Luna<DecalComponent_BindLua>::FunctionType DecalComponent_BindLua::methods[] = {
    ...
    {NULL, NULL}};
Luna<DecalComponent_BindLua>::PropertyType
    DecalComponent_BindLua::properties[] = {{NULL, NULL}};
...
int DecalComponent_BindLua::SetBaseColorOnlyAlpha(lua_State *L) {
  ...
  if (argc > 0) {
    ...
    wi::lua::SError(L,
                    "SetBaseColorOnlyAlpha(bool value) not enough arguments!");
  }
  return 0;
}
...
Luna<MetadataComponent_BindLua>::FunctionType
    MetadataComponent_BindLua::methods[] = {
        ...
        {NULL, NULL}};
Luna<MetadataComponent_BindLua>::PropertyType
    MetadataComponent_BindLua::properties[] = {{NULL, NULL}};
...
int MetadataComponent_BindLua::SetBool(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(L,
                    "SetBool(string name, bool value) not enough arguments!");
    return 0;
  }
  std::string name = wi::lua::SGetString(L, 1);
...
int MetadataComponent_BindLua::SetFloat(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(L,
                    "SetFloat(string name, float value) not enough arguments!");
    return 0;
  }
  std::string name = wi::lua::SGetString(L, 1);
...
int MetadataComponent_BindLua::SetString(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(
        L, "SetString(string name, string value) not enough arguments!");
    return 0;
  }
  std::string name = wi::lua::SGetString(L, 1);
...
Luna<CharacterComponent_BindLua>::FunctionType
    CharacterComponent_BindLua::methods[] = {
        ...
        lunamethod(CharacterComponent_BindLua,
                   SetCharacterToCharacterCollisionDisabled),
        ...
        lunamethod(CharacterComponent_BindLua,
                   IsCharacterToCharacterCollisionDisabled),
        ...
        {NULL, NULL}};
Luna<CharacterComponent_BindLua>::PropertyType
    CharacterComponent_BindLua::properties[] = {{NULL, NULL}};
...
int CharacterComponent_BindLua::Shake(lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc < 1) {
    wi::lua::SError(L, "Shake(float horizontal, opt float vertical = 0) not "
                       "enough arguments!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetWaterVerticalOffset(lua_State *L) {
  ...
  if (argc < 1) {
    wi::lua::SError(
        L, "SetWaterVerticalOffset(float value) not enough arguments!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetPosition(lua_State *L) {
  ...
  if (v == nullptr) {
    wi::lua::SError(
        L, "SetPosition(Vector value) first argument is not a Vector!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetVelocity(lua_State *L) {
  ...
  if (v == nullptr) {
    wi::lua::SError(
        L, "SetVelocity(Vector value) first argument is not a Vector!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetFacing(lua_State *L) {
  ...
  if (v == nullptr) {
    wi::lua::SError(L,
                    "SetFacing(Vector value) first argument is not a Vector!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetRelativeOffset(lua_State *L) {
  ...
  if (v == nullptr) {
    wi::lua::SError(
        L, "SetRelativeOffset(Vector value) first argument is not a Vector!");
    return 0;
  }
...
int CharacterComponent_BindLua::SetFootPlacementEnabled(lua_State *L) {
  ...
  if (argc < 1) {
    wi::lua::SError(
        L, "SetFootPlacementEnabled(bool value) not enough arguments!");
    return 0;
  }
  component->SetFootPlacementEnabled(wi::lua::SGetBool(L, 1));
  return 0;
}
int CharacterComponent_BindLua::SetCharacterToCharacterCollisionDisabled(
    lua_State *L) {
  int argc = wi::lua::SGetArgCount(L);
  if (argc < 1) {
    wi::lua::SError(L, "SetCharacterToCharacterCollisionDisabled(bool value) "
                       "not enough arguments!");
    return 0;
  }
...
int CharacterComponent_BindLua::IsCharacterToCharacterCollisionDisabled(
    lua_State *L) {
...
int CharacterComponent_BindLua::SetPathGoal(lua_State *L) {
  ...
  if (argc < 2) {
    wi::lua::SError(
        L,
        "SetPathGoal(Vector goal, VoxelGrid voxelgrid) not enough arguments!");
    return 0;
  }
  Vector_BindLua *v = Luna<Vector_BindLua>::lightcheck(L, 1);
  if (v == nullptr) {
    wi::lua::SError(L, "SetPathGoal(Vector goal, VoxelGrid voxelgrid) first "
                       "argument is not a Vector!");
    return 0;
  }
  VoxelGrid_BindLua *p = Luna<VoxelGrid_BindLua>::lightcheck(L, 2);
  if (p == nullptr) {
    wi::lua::SError(L, "SetPathGoal(Vector goal, VoxelGrid voxelgrid) second "
                       "argument is not a VoxelGrid!");
    return 0;
  }
