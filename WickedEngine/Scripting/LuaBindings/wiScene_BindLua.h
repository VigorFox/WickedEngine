...
//	Then this can be used to override the global GetScene() in lua scripts
// with a custom scene
void SetGlobalScene(wi::scene::Scene *scene);
// If the application doesn't use the global camera, but manages it manually,
//	Then this can be used to override the global GetCamera() in lua scripts
...
class Scene_BindLua {
private:
  std::unique_ptr<wi::scene::Scene>
      owning; // GetScene() is too slow if scene object is always constructed
public:
  ...
  Scene_BindLua(lua_State *L)
      : owning(std::make_unique<wi::scene::Scene>()), scene(owning.get()) {}
...
public:
  ...
  RayIntersectionResult_BindLua(
      const wi::scene::Scene::RayIntersectionResult &result)
      : result(result) {}
  RayIntersectionResult_BindLua(
      wi::scene::Scene::RayIntersectionResult &&result)
...
public:
  ...
  SphereIntersectionResult_BindLua(
      const wi::scene::Scene::SphereIntersectionResult &result)
      : result(result) {}
  SphereIntersectionResult_BindLua(
      wi::scene::Scene::SphereIntersectionResult &&result)
      : result(std::move(result)) {}
...
public:
  ...
  PropertyFunction(Translation_local) PropertyFunction(Rotation_local)
...
public:
  ...
  inline void BuildBindings() {
    _flags =
        LongLongProperty(reinterpret_cast<long long *>(&component->_flags));
    ShaderType = IntProperty(reinterpret_cast<int *>(&component->shaderType));
    UserBlendMode =
        IntProperty(reinterpret_cast<int *>(&component->userBlendMode));
    ...
    ParallaxOcclusionMapping =
        FloatProperty(&component->parallaxOcclusionMapping);
  ...
  PropertyFunction(_flags) PropertyFunction(ShaderType) PropertyFunction(
      UserBlendMode) PropertyFunction(SpecularColor)
      PropertyFunction(SubsurfaceScattering) PropertyFunction(
          TexMulAdd) PropertyFunction(Roughness) PropertyFunction(Reflectance)
          PropertyFunction(Metalness) PropertyFunction(NormalMapStrength)
              PropertyFunction(ParallaxOcclusionMapping) PropertyFunction(
                  DisplacementMapping) PropertyFunction(Refraction)
                  PropertyFunction(Transmission) PropertyFunction(
                      Cloak) PropertyFunction(ChromaticAberration)
                      PropertyFunction(Saturation) PropertyFunction(
                          AlphaRef) PropertyFunction(SheenColor)
                          PropertyFunction(SheenRoughness) PropertyFunction(
                              Clearcoat) PropertyFunction(ClearcoatRoughness)
                              PropertyFunction(ShadingRate) PropertyFunction(
                                  TexAnimDirection)
...
public:
  ...
  inline void BuildBindings() {
    ...
    ArmatureID =
        LongLongProperty(reinterpret_cast<long long *>(&component->armatureID));
    SubsetsPerLOD = LongLongProperty(
        reinterpret_cast<long long *>(&component->subsets_per_lod));
  }
  ...
  MeshComponent_BindLua(lua_State *L) : component(&owning) { BuildBindings(); }
  ...
  PropertyFunction(_flags) PropertyFunction(TessellationFactor)
      PropertyFunction(ArmatureID) PropertyFunction(SubsetsPerLOD)
...
public:
  ...
  inline void BuildBindings() {
    ...
    SpriteSheet_Frames_X =
        LongLongProperty(reinterpret_cast<long long *>(&component->framesX));
    SpriteSheet_Frames_Y =
        LongLongProperty(reinterpret_cast<long long *>(&component->framesY));
    SpriteSheet_Frame_Count =
        LongLongProperty(reinterpret_cast<long long *>(&component->frameCount));
    SpriteSheet_Frame_Start =
        LongLongProperty(reinterpret_cast<long long *>(&component->frameStart));
  ...
  PropertyFunction(_flags)
      ...
      PropertyFunction(ShaderType)
          ...
          PropertyFunction(Mass) PropertyFunction(Velocity) PropertyFunction(
              Gravity) PropertyFunction(Drag) PropertyFunction(Restitution)

              PropertyFunction(SPH_h) PropertyFunction(SPH_K)
                  PropertyFunction(SPH_p0) PropertyFunction(SPH_e)
...
public:
  ...
  inline void BuildBindings() {
    ...
    StrandCount = LongLongProperty(
        reinterpret_cast<long long *>(&component->strandCount));
    SegmentCount = LongLongProperty(
        reinterpret_cast<long long *>(&component->segmentCount));
    RandomSeed =
        LongLongProperty(reinterpret_cast<long long *>(&component->randomSeed));
    ...
    // SpriteSheet_Frames_X = LongLongProperty(reinterpret_cast<long
    // long*>(&component->framesX)); SpriteSheet_Frames_Y =
    // LongLongProperty(reinterpret_cast<long long*>(&component->framesY));
    // SpriteSheet_Frame_Count = LongLongProperty(reinterpret_cast<long
    // long*>(&component->frameCount)); SpriteSheet_Frame_Start =
    // LongLongProperty(reinterpret_cast<long long*>(&component->frameStart));
  }
  ...
  PropertyFunction(_flags)
      ...
      PropertyFunction(StrandCount) PropertyFunction(SegmentCount)
          PropertyFunction(RandomSeed) PropertyFunction(Length)
              PropertyFunction(Stiffness) PropertyFunction(Randomness)
...
public:
  ...
  InverseKinematicsComponent_BindLua(
      wi::scene::InverseKinematicsComponent *component)
      : component(component) {}
...
public:
  ...
  PropertyFunction(DragForce) PropertyFunction(HitRadius)
      PropertyFunction(GravityPower) PropertyFunction(GravityDirection)
...
public:
  ...
  inline void BuildBindings() {
    ...
    TargetMeshLOD =
        LongLongProperty(reinterpret_cast<long long *>(&component->mesh_lod));
  ...
  RigidBodyPhysicsComponent_BindLua(
      wi::scene::RigidBodyPhysicsComponent *component)
      : component(component) {
    BuildBindings();
  }
  ...
  PropertyFunction(Shape) PropertyFunction(Mass) PropertyFunction(Friction)
      PropertyFunction(Restitution) PropertyFunction(LinearDamping)
          PropertyFunction(AngularDamping) PropertyFunction(Buoyancy)
              PropertyFunction(BoxParams_HalfExtents) PropertyFunction(
                  SphereParams_Radius) PropertyFunction(CapsuleParams_Radius)
...
public:
  ...
  SoftBodyPhysicsComponent_BindLua(
      wi::scene::SoftBodyPhysicsComponent *component)
      : component(component) {
    BuildBindings();
  }
  ...
  PropertyFunction(Mass) PropertyFunction(Friction)
      PropertyFunction(Restitution) PropertyFunction(VertexRadius)
...
public:
  ...
  PropertyFunction(Type) PropertyFunction(Gravity) PropertyFunction(Range)
};
...
public:
  ...
  inline void BuildBindings() {
    ...
    surfaceDisplacementTolerance =
        FloatProperty(&parameter->surfaceDisplacementTolerance);
  }
  ...
  PropertyFunction(dmap_dim) PropertyFunction(patch_length)
      PropertyFunction(time_scale) PropertyFunction(wave_amplitude)
          PropertyFunction(wind_dir) PropertyFunction(wind_speed)
              PropertyFunction(wind_dependency) PropertyFunction(choppy_scale)
                  PropertyFunction(waterColor) PropertyFunction(waterHeight)
...
public:
  ...
  inline void BuildBindings() {
    ...
    rayleighDensityExpScale =
        FloatProperty(&parameter->rayleighDensityExpScale);
    ...
    absorptionDensity0LayerWidth =
        FloatProperty(&parameter->absorptionDensity0LayerWidth);
    absorptionDensity0ConstantTerm =
        FloatProperty(&parameter->absorptionDensity0ConstantTerm);
    absorptionDensity0LinearTerm =
        FloatProperty(&parameter->absorptionDensity0LinearTerm);
    absorptionDensity1ConstantTerm =
        FloatProperty(&parameter->absorptionDensity1ConstantTerm);
    absorptionDensity1LinearTerm =
        FloatProperty(&parameter->absorptionDensity1LinearTerm);
  ...
  PropertyFunction(bottomRadius) PropertyFunction(topRadius) PropertyFunction(
      planetCenter) PropertyFunction(rayleighDensityExpScale)
      PropertyFunction(rayleighScattering) PropertyFunction(mieDensityExpScale)
          PropertyFunction(mieScattering) PropertyFunction(mieExtinction)
              PropertyFunction(mieAbsorption) PropertyFunction(miePhaseG)
...
public:
  ...
  inline void BuildBindings() {
    cloudAmbientGroundMultiplier =
        FloatProperty(&parameter->ambientGroundMultiplier);
    ...
    extinctionCoefficientFirst =
        VectorProperty(&parameter->layerFirst.extinctionCoefficient);

    skewAlongWindDirectionFirst =
        FloatProperty(&parameter->layerFirst.skewAlongWindDirection);
    totalNoiseScaleFirst =
        FloatProperty(&parameter->layerFirst.totalNoiseScale);
    curlScaleFirst = FloatProperty(&parameter->layerFirst.curlScale);
    curlNoiseModifierFirst =
        FloatProperty(&parameter->layerFirst.curlNoiseModifier);
    detailScaleFirst = FloatProperty(&parameter->layerFirst.detailScale);
    detailNoiseModifierFirst =
        FloatProperty(&parameter->layerFirst.detailNoiseModifier);
    skewAlongCoverageWindDirectionFirst =
        FloatProperty(&parameter->layerFirst.skewAlongCoverageWindDirection);
    ...
    coverageMinimumFirst =
        FloatProperty(&parameter->layerFirst.coverageMinimum);
    ...
    anvilDeformationSmallFirst =
        VectorProperty(&parameter->layerFirst.anvilDeformationSmall);
    anvilDeformationMediumFirst =
        VectorProperty(&parameter->layerFirst.anvilDeformationMedium);
    anvilDeformationLargeFirst =
        VectorProperty(&parameter->layerFirst.anvilDeformationLarge);
    ...
    coverageWindSpeedFirst =
        FloatProperty(&parameter->layerFirst.coverageWindSpeed);
    coverageWindAngleFirst =
        FloatProperty(&parameter->layerFirst.coverageWindAngle);

    // Second layer
    albedoSecond = VectorProperty(&parameter->layerSecond.albedo);
    extinctionCoefficientSecond =
        VectorProperty(&parameter->layerSecond.extinctionCoefficient);

    skewAlongWindDirectionSecond =
        FloatProperty(&parameter->layerSecond.skewAlongWindDirection);
    totalNoiseScaleSecond =
        FloatProperty(&parameter->layerSecond.totalNoiseScale);
    curlScaleSecond = FloatProperty(&parameter->layerSecond.curlScale);
    curlNoiseModifierSecond =
        FloatProperty(&parameter->layerSecond.curlNoiseModifier);
    detailScaleSecond = FloatProperty(&parameter->layerSecond.detailScale);
    detailNoiseModifierSecond =
        FloatProperty(&parameter->layerSecond.detailNoiseModifier);
    skewAlongCoverageWindDirectionSecond =
        FloatProperty(&parameter->layerSecond.skewAlongCoverageWindDirection);
    weatherScaleSecond = FloatProperty(&parameter->layerSecond.weatherScale);
    coverageAmountSecond =
        FloatProperty(&parameter->layerSecond.coverageAmount);
    coverageMinimumSecond =
        FloatProperty(&parameter->layerSecond.coverageMinimum);
    ...
    gradientMediumSecond =
        VectorProperty(&parameter->layerSecond.gradientMedium);
    gradientLargeSecond = VectorProperty(&parameter->layerSecond.gradientLarge);

    anvilDeformationSmallSecond =
        VectorProperty(&parameter->layerSecond.anvilDeformationSmall);
    anvilDeformationMediumSecond =
        VectorProperty(&parameter->layerSecond.anvilDeformationMedium);
    anvilDeformationLargeSecond =
        VectorProperty(&parameter->layerSecond.anvilDeformationLarge);
    ...
    coverageWindSpeedSecond =
        FloatProperty(&parameter->layerSecond.coverageWindSpeed);
    coverageWindAngleSecond =
        FloatProperty(&parameter->layerSecond.coverageWindAngle);
  }
  ...
  PropertyFunction(cloudAmbientGroundMultiplier)
      ...
      PropertyFunction(horizonBlendAmount) PropertyFunction(horizonBlendPower)
          PropertyFunction(cloudStartHeight) PropertyFunction(cloudThickness)

              PropertyFunction(animationMultiplier)

      // First layer
      PropertyFunction(albedoFirst) PropertyFunction(extinctionCoefficientFirst)

          PropertyFunction(skewAlongWindDirectionFirst) PropertyFunction(
              totalNoiseScaleFirst) PropertyFunction(curlScaleFirst)
              PropertyFunction(curlNoiseModifierFirst) PropertyFunction(
                  detailScaleFirst) PropertyFunction(detailNoiseModifierFirst)
                  PropertyFunction(skewAlongCoverageWindDirectionFirst) PropertyFunction(
                      weatherScaleFirst) PropertyFunction(coverageAmountFirst)
                      PropertyFunction(coverageMinimumFirst) PropertyFunction(
                          typeAmountFirst) PropertyFunction(typeMinimumFirst)
                          PropertyFunction(rainAmountFirst) PropertyFunction(
                              rainMinimumFirst)

                              PropertyFunction(gradientSmallFirst) PropertyFunction(
                                  gradientMediumFirst) PropertyFunction(gradientLargeFirst)
      ...
      // Second layer
      PropertyFunction(albedoSecond) PropertyFunction(
          extinctionCoefficientSecond)

          PropertyFunction(skewAlongWindDirectionSecond) PropertyFunction(
              totalNoiseScaleSecond) PropertyFunction(curlScaleSecond)
              PropertyFunction(curlNoiseModifierSecond) PropertyFunction(
                  detailScaleSecond) PropertyFunction(detailNoiseModifierSecond)
                  PropertyFunction(skewAlongCoverageWindDirectionSecond) PropertyFunction(
                      weatherScaleSecond) PropertyFunction(coverageAmountSecond)
                      PropertyFunction(coverageMinimumSecond) PropertyFunction(
                          typeAmountSecond) PropertyFunction(typeMinimumSecond)
                          PropertyFunction(rainAmountSecond) PropertyFunction(
                              rainMinimumSecond)

                              PropertyFunction(gradientSmallSecond) PropertyFunction(
                                  gradientMediumSecond)
...
public:
  ...
  inline void BuildBindings() {
    ...
    AtmosphereParameters =
        Weather_AtmosphereParams_Property(&component->atmosphereParameters);
    VolumetricCloudParameters = Weather_VolumetricCloudParams_Property(
        &component->volumetricCloudParameters);
    ...
    volumetricCloudsWeatherMapFirstName =
        StringProperty(&component->volumetricCloudsWeatherMapFirstName);
    volumetricCloudsWeatherMapSecondName =
        StringProperty(&component->volumetricCloudsWeatherMapSecondName);
  }
  ...
  PropertyFunction(sunColor) PropertyFunction(sunDirection) PropertyFunction(
      skyExposure) PropertyFunction(horizon) PropertyFunction(zenith)
      PropertyFunction(ambient) PropertyFunction(fogStart) PropertyFunction(
          fogDensity) PropertyFunction(fogHeightStart)
          PropertyFunction(fogHeightEnd) PropertyFunction(fogHeightSky)
              PropertyFunction(cloudiness) PropertyFunction(cloudScale)
                  PropertyFunction(cloudSpeed) PropertyFunction(
                      cloud_shadow_amount) PropertyFunction(cloud_shadow_scale)
                      PropertyFunction(cloud_shadow_speed) PropertyFunction(
                          windDirection) PropertyFunction(gravity)
                          PropertyFunction(windRandomness) PropertyFunction(
                              windWaveSize) PropertyFunction(windSpeed)
                              PropertyFunction(stars) PropertyFunction(
  ...
  PropertyFunction(OceanParameters) PropertyFunction(AtmosphereParameters)
  ...
  PropertyFunction(skyMapName) PropertyFunction(colorGradingMapName)
...
public:
  ...
  SoundComponent_BindLua(lua_State *L) : component(&owning) { BuildBindings(); }

  StringProperty Filename;
  FloatProperty Volume;

  PropertyFunction(Filename) PropertyFunction(Volume)
...
public:
  ...
  VideoComponent_BindLua(wi::scene::VideoComponent *component)
      : component(component) {
    BuildBindings();
  }
  VideoComponent_BindLua(lua_State *L) : component(&owning) { BuildBindings(); }
...
public:
  ...
  PropertyFunction(Shape) PropertyFunction(Radius) PropertyFunction(Offset)
...
public:
  ...
  CharacterComponent_BindLua(wi::scene::CharacterComponent *component)
      : component(component) {}
